  ...
  private void splayNode(BinaryTreeNode node) {
    ...
    while (node.parent != null) {
      if (node.parent.parent==null) {
        ...
        if (node.parent.parent.leftChild!=null&&node==node.parent.parent.leftChild.leftChild) {
          zigZig(node);
        }else if (node.parent.parent.rightChild!=null&&node==node.parent.parent.rightChild.rightChild) {
          zigZig(node);
        }else{
          zigZag(node);
        }
