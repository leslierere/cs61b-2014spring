...
public class SList {
  ...
  public void squish() {
    ...
    SListNode testNext = head;
    while (testNext!=null&&testNext.next!=null){ 
      while (testNext.item.equals(testNext.next.item)){
        testNext.next = testNext.next.next;
        if (testNext.next == null){
          break;
        }
      }
